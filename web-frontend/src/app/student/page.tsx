      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div whileHover={{ y: -5 }} className="bg-slate-900 border border-slate-800 p-6 rounded-2xl relative overflow-hidden">
            ...
            <p className="text-4xl font-extrabold text-white">{studentData.overallAttendance ?? 'null'}</p>
            <div className="mt-4 w-full bg-slate-800 rounded-full h-2">
              <div 
                className="bg-blue-500 h-2 rounded-full" 
                style={{ width: studentData.overallAttendance || '0%' }}
              />
            </div>
          </motion.div>
          ...
          <motion.div whileHover={{ y: -5 }} className="bg-slate-900 border border-slate-800 p-6 rounded-2xl relative overflow-hidden">
            ...
            <p className="text-3xl font-extrabold text-emerald-400">{studentData.eligibility ?? 'null'}</p>
